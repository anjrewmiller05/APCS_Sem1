...
class starter {
 	...
 	public static int checkVertical(String[][] board){
		for(int x = board.length-1; x>2; x--) {
			for(int y = 0; y<board[0].length; y++) {
				if((board[x][y].equals("A")) && (board[x-1][y].equals("A")) && (board[x-2][y].equals("A")) && (board[x-3][y].equals("A"))) {
					return 1;
				}
				else if((board[x][y].equals("B")) && (board[x-1][y].equals("B")) && (board[x-2][y].equals("B")) && (board[x-3][y].equals("B"))) {
					return 2;
				}
			}
		}
	...
	public static int checkHorizontal(String[][] board){
		for(int x = board.length-1; x>-1; x--) {
			for(int y = 0; y<4; y++) {
				if((board[x][y].equals("A")) && (board[x][y+1].equals("A")) && (board[x][y+2].equals("A")) && (board[x][y+3].equals("A"))) {
					return 1;
				}
				else if((board[x][y].equals("B")) && (board[x][y+1].equals("B")) && (board[x][y+2].equals("B")) && (board[x][y+3].equals("B"))) {
					return 2;
				}
			}
		}
